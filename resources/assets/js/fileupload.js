...
(function($) {
    upload = function(arg) {
        ...
        var builPicdata = function(dataid, data) {
            var obj;
            if($('#' + dataid).val() != "") {
        ...
        var deletePicdata= function(dataid, media_key) {
        ...
        var uploadInit=function(filestr, _fileroot) {
            var initData = {};
            var preview = [];
            var preconfig = [];
            if(filestr != "") {

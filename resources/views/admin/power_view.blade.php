                        ...
                        <div class="col-md-8">
                            <form class="form-horizontal m-t" id="addform">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control" name="parent_id" id="parent_id">
                                                @foreach($pname as $k=>$v)
                                                    <option value="{{$info->parent_id}}"  @if($info->parent_id == $v->id ) selected="selected" @endif> {{$v->pname}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="purl" name="purl" type="text" class="form-control" value="{{$info->purl}}">
                                    </div>
                                </div>
                                <div class="form-group">
